...
public class LejosLink {
	...
	public void setByteOrder(int aByteOrder) {
		...
		if ((aByteOrder != IRuntimeToolset.BYTE_ORDER_BIG_ENDIAN)
			...
			throw new IllegalArgumentException(
				"Wrong byte order: " + String.valueOf(aByteOrder));
		}
	 ...
	 */
	public void prepareCompiledClasses(
		String[] classFiles,
		String[] args,
		Classpath classpath)
	 ...
	 * 
	 * <p>
	 * It will create the output files based on the previous <code>prepareCompiledClasses()</code>.
	 * </p>
	 * 
