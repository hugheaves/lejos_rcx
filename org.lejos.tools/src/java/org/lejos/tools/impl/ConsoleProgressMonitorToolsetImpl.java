...
/**
 * This is the default implementation of a standard <code>IProgressMonitorToolset</code>.
 * 
 * <p>
 ...
 */
public class ConsoleProgressMonitorToolsetImpl
	 ...
	 * @param aTotalWork the total number of work units into which the main
	 *        task is been subdivided. If the value is <code>UNKNOWN</code>
	 *        the implemenation is free to indicate progress in a way which
	 *        doesn't require the total number of work units in advance.
	 */
	public void beginTask(String name, int aTotalWork) {
		if (this.used) {
			throw new IllegalStateException("A progress monitor can NOT be used multiple times");
		}
	 ...
	 * completed. Note that this amount represents an installment, as opposed
	 * to a cumulative amount of work done to date.
	 * 
