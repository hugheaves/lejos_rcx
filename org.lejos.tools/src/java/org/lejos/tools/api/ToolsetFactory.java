...
public class ToolsetFactory {
     ...
     *             will be raised in any error case, e.g. if a progress monitor
    ...
    public IProgressMonitorToolset newProgressMonitor() throws ToolsetException {
        ...
        try {
            ...
            throw new ToolsetException("progress monitor class "
                    + String.valueOf(progressMonitorClassName) + " not found",
                    ex);
     ...
     * 
     * @param aFeatures
     *            the given features to use for cration of the factory
     * @return a new factory
     */
        ...
        try {
            ...
            if (!(factoryObj instanceof ToolsetFactory)) {
                throw new FactoryConfigurationError(
                        "factory class name invalid: " + "Not an instance of "
            ...
            throw new FactoryConfigurationError(
                    "factory class " + String.valueOf(factoryClassName)
                            + " could not be access", ex);
        }
    }
}