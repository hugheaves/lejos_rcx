...
/**
 * The <code>ToolsetFactory</code> creates the required implementation
 * classes which supports the toolset api.
 * 
 * <p>
...
public class ToolsetFactory {
	...
	public static final String FACTORY_CLASS_PROPERTY =
		"org.lejos.tools.api.factory";

	/** Name of the default factory. */
	private static final String DEFAULT_FACTORY_CLASS_NAME =
		"org.lejos.tools.api.ToolsetFactory";

	/**
	 * Name of the property, which specifies the progress monitor to be used.
	 */
	public static final String PROGRESS_MONITOR_CLASS_PROPERTY =
		"org.lejos.tools.api.monitor";

	/** Name of the default progress monitor. */
	private static final String DEFAULT_PROGRESS_MONITOR_CLASS_NAME =
		"org.lejos.tools.impl.ConsoleProgressMonitorToolsetImpl";
	 ...
	 */
	public IProgressMonitorToolset newProgressMonitor()
		throws ToolsetException {
		// this property specifies the factory class name
		String progressMonitorClassName =
			this.features.getProperty(PROGRESS_MONITOR_CLASS_PROPERTY);
		...
		try {
			...
			if (!(progressMonitorObj instanceof IProgressMonitorToolset)) {
				throw new ToolsetException(
					"progress monitor class name invalid: "
						+ "Not an instance of "
						+ IProgressMonitorToolset.class.getName());
			}
			IProgressMonitorToolset progressMonitor =
				(IProgressMonitorToolset) progressMonitorObj;
	...
	public static ToolsetFactory newInstance(Properties aFeatures) {
		...
		try {
			...
			throw new FactoryConfigurationError(
				"factory class "
					+ String.valueOf(factoryClassName)
					+ " not found",
				ex);
		} catch (InstantiationException ex) {
			throw new FactoryConfigurationError(
