...
/**
 * This is the common interface to access the leJOS development toolset.
 * 
 * <p>
 * Will (in future) support services like <code>GenerateConstants</code>,
 * etc.
 * </p>
 * 
...
public interface IDevelopmentToolset
{
   ...
   /**
    * Sets ths verbose option for the whole toolset. If set to true, some useful
   ...
   /**
    * Sets ths output writer to be used for printing out verbose mnessages.
    * 
    * <p>
