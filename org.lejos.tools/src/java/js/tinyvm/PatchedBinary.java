...
public class PatchedBinary extends Binary
{
  ...
  public static PatchedBinary patchedCreateFromClosureOf (Vector aEntryClasses,
      ClassPath aClassPath, boolean aAll) throws Exception
  {
  ...
  public void report () throws TinyVMException
  {
    ...
    appendSignature("Master record : " + iMasterRecord.getLength() + " bytes.");
      ...
      throws TinyVMException
  {
    ...
    for (int i = 0; i < CLASSES.length; i++)
    {
      ...
      ClassRecord pRec = PatchedClassRecord.patchedGetClassRecord(pName,
          aClassPath, this);
  ...
  public void processMethods (boolean iAll) throws TinyVMException
  {
    ...
    for (int pIndex = 0; pIndex < pSize; pIndex++)
    {
      PatchedClassRecord pRec = (PatchedClassRecord) iClassTable
          .elementAt(pIndex);
