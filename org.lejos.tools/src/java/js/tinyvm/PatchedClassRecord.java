...
public class PatchedClassRecord extends ClassRecord
{
      ...
      Binary aBinary) throws TinyVMException
  {
    ...
    {
      throw new TinyVMException("Exception reading " + aName);
    }
    try
    {
      pBufIn.close();
  ...
  public void storeMethods (RecordTable aMethodTables,
      ...
      PrintWriter writer) throws TinyVMException
  {
      ...
      throws TinyVMException
  {
    ...
    while (pEntries.hasMoreElements())
    {
      ...
      if (pEntry instanceof JCPE_Class)
      {
        ...
        {
          ClassRecord pRec = PatchedClassRecord.patchedGetClassRecord(
              pClassName, aClassPath, iBinary);
      ...
      else if (pEntry instanceof JCPE_NameAndType)
      {
            ...
            "("))
        {
          if (!((JCPE_NameAndType) pEntry).getName().substring(0, 1)
              .equals("<"))
          {
            // System.out.println("Method by variable: " + ((JCPE_NameAndType)
            // pEntry).getName()+":"+((JCPE_NameAndType)
            // pEntry).getDescriptor());
   ...
   * @return Object
   */
  public static void setProtectedField (Object instance, String fieldName,
      Object val)
  {
    try
    {
