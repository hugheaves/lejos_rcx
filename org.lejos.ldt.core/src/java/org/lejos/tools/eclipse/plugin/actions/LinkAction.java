...
public class LinkAction
	 ...
	 * to get a working context for the action, such as the shell for any
	 * dialog which is needed.
	 * <p>
	 * This method will be called every time the action appears in a popup
	 * menu. The targetPart may change with each invocation.
	 * </p>
	 * 
	 ...
	 * not, a message will be displayed, who indicates "no classes" available.
	 * If there are compilation units, the link will be started for all of
	 * them.
	 * </p>
	 * 
	...
	public void run(IAction action) {
		...
		try {
			...
			MessageDialog.openError(
				null,
				null,
				"Internal error: (" + ex.getMessage() + ") occured");
